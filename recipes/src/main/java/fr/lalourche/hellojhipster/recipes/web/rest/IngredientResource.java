...
import fr.lalourche.hellojhipster.recipes.repository.IngredientRepository;
import fr.lalourche.hellojhipster.recipes.repository.search.IngredientSearchRepository;
...
/**
 * REST controller for managing {@link fr.lalourche.hellojhipster.recipes.domain.Ingredient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class IngredientResource {
    ...
    private static final String ENTITY_NAME = "recipesIngredient";
