...
@Configuration
@EnableR2dbcRepositories("fr.lalourche.hellojhipster.gateway.repository")
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("fr.lalourche.hellojhipster.gateway.repository.search")
