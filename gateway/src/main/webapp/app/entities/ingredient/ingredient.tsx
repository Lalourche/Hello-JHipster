...
import { getSearchEntities, getEntities } from './ingredient.reducer';
  ...
  return (
    <div>
      <h2 id="ingredient-heading" data-cy="IngredientHeading">
        <Translate contentKey="gatewayApp.ingredient.home.title">Ingredients</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.ingredient.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.ingredient.home.createLabel">Create new Ingredient</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('gatewayApp.ingredient.home.search')}
                />
        ...
        {ingredientList && ingredientList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.ingredient.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.ingredient.home.notFound">No Ingredients found</Translate>
            </div>
          )
        )}
      </div>
