package fr.lalourche.hellojhipster.gateway.config.apidocs;

import static fr.lalourche.hellojhipster.gateway.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
